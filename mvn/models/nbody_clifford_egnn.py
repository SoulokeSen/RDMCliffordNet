...
#        batch = batch.to("cuda")
        ...
        print("input_pos, vel, charges", input_pos.shape, batch.vel.unsqueeze(1).shape, s.shape)
        ...
        loss = F.mse_loss(pred_pos, batch.y.reshape(-1, 3), reduction="none").mean(dim=1) #is these node level targets
